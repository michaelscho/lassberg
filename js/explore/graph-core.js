 ...
 * serialization-format graph exported by scripts/export_graph_json.py (json/explore/graph.json).
 *
 ...
 * Graphology/Sigma (js/explore/graph.js) are only needed for the interactive visualization, not
 * for this expansion logic.
 *
